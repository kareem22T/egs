<template>
    <main class="contact_wrapper">
        ...
        <div class="container">
            ...
            <div class="body">
                <form @submit.prevent>
                    <input type="text" name="first_name" id="first_name" placeholder="First Name" v-model="first_name">
                    <input type="text" name="last_name" id="last_name" placeholder="Last Name" v-model="last_name">
